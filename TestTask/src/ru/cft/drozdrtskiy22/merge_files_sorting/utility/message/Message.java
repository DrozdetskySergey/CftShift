...
public enum Message {
    ...
    KEYS("-a  сортировка по возростанию. -d  сортировка по убыванию. -s данные в виде String. -i данные в виде" +
            " Integer. Параметр сортировки не обезателен, тогда по возростанию."),
